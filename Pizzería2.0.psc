 Funcion menuprincipal (TotalGeneral Por Referencia, TotalMesa Por Referencia, pizza Por Referencia)
	Imprimir "================================"
	...
	Para i<-1 Hasta nmesas Con Paso 1 Hacer
		...
		adicionales(TotalMesa,adicional)
		
		Bebidas(TotalMesa,bebida)
...
Funcion adicionales(TotalMesa Por Referencia, adicional Por Referencia)
	Imprimir "==========================="
...
Funcion Bebidas ( TotalMesa Por Referencia, bebida Por Referencia)
	Limpiar Pantalla 
	Imprimir "==========================="
	...
	Segun bebida Hacer
		1:
			TamañoBebida(Tbebida,TotalMesa)
		2:	
			TamañoBebida(Tbebida,TotalMesa)
		3:
			TamañoBebida(Tbebida,TotalMesa)
...
Funcion TamañoBebida(Tbebida Por Referencia,TotalMesa Por Referencia)
	Imprimir "============================="
...
Algoritmo Pizzería
	menuprincipal(TotalGeneral,TotalMesa,pizza)
FinAlgoritmo
